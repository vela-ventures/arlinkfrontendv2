...
import type { ArnsName, Steps } from "@/index";
...
const ConfiguringDeploymentProject = ({
	...
	const [deploymentSucceded, setDeploymentSucceded] = useState<boolean>(false);
	...
	return (
		<div className="min-h-screen text-white px-8 max-w-3xl mx-auto">
			...
			<h1 className="text-2xl font-bold mb-6">Set up ur deployment process</h1>
						...
						<div className="flex items-center gap-4 mt-2">
							...
							<div className="flex-1">
								<h3 className="text-lg font-semibold">
									{projectName.length === 0 ? "Project Name" : projectName}
								</h3>
								<div className="flex items-center gap-2 text-sm text-neutral-400">
									<Globe className="w-4 h-4" />
									<div className="hover:underline">
										{activeTab === "arlink"
											? `${customArnsName.length === 0 ? projectName.toLowerCase() : customArnsName.toLocaleLowerCase()}.arlink.arweave.net`
					...
					<div>
						...
						<div className="flex relative ">
							...
							<Button
								...
								onClick={() => setIsRootDirectoryDrawerOpen(true)}
							>
								Change
							</Button>
						</div>
			...
			<div className="bg-[#0C0C0C] p-6 rounded-lg mb-6 border border-[#383838]">
				...
				<div className="space-y-4">
					<div>
						<p className="mb-3 font-medium text-sm">Build command</p>
						<div className="relative">
							...
							<Input
								...
								onChange={(e) =>
									handleSettingChange("buildCommand", "value", e.target.value)
								}
					...
					<div>
						<p className="mb-3 font-medium text-sm">Install command</p>
						<div className="relative">
							<div className="flex items-center absolute right-2 z-10 top-1/2 -translate-y-1/2 justify-between">
								<Switch
									checked={buildSettings.installCommand.enabled}
									onCheckedChange={(checked) =>
										handleSettingChange("installCommand", "enabled", checked)
									}
								/>
							</div>
							<Input
								...
								onChange={(e) =>
									handleSettingChange("installCommand", "value", e.target.value)
								}
						...
						<div className="relative">
							<div className="flex items-center absolute right-2 z-10 top-1/2 -translate-y-1/2 justify-between">
								<Switch
									...
									onCheckedChange={(checked) =>
										handleSettingChange("outPutDir", "enabled", checked)
									}
								/>
							</div>
							<Input
								...
								onChange={(e) =>
									handleSettingChange("outPutDir", "value", e.target.value)
								}
