...
export default function ArchiveDeploy() {
    ...
    async function fetchBranches() {
        ...
        try {
            ...
            setBranches(
                (response.data as any[]).map((branch: any) => branch.name)
            );
        } catch (error) {
    ...
    const deploy = useCallback(async () => {
        ...
        console.log({
            ...
            deploymentAvailable: deployments.find(
                (dep) => dep.Name === projName
            ),
            githubToken,
            finalArnsProcess,
            customRepo,
        ...
        if (selectedUrl) {
            ...
            try {
                ...
                if (matchingConfig) {
                    ...
                    setInstallCommand(
                        matchingConfig.InstallCMD || "npm install"
                    );
                    ...
                    {step === "initial" && (
                        <div className="space-y-6">
                            <h2 className="text-xl font-semibold">
                                Select a Git provider to import an existing
                                project
                            </h2>
                    ...
                    {step === "repository" && (
                        <div className="space-y-6">
                            ...
                            <select
                                ...
                                value={repoUrl}
                                onChange={(e) =>
                                    handleRepositorySelection(e.target.value)
                                }
                            >
...
function TemplateSelection() {
    return (
        <Card className="bg-arlink-bg-secondary-color relative p-6 rounded-lg flex flex-col">
