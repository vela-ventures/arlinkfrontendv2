import { MostUsedBrowserInterface } from "@/types";
import {
    Card,
    CardContent,
    CardDescription,
...
const MostUsedBrowser = ({ data }: { data: MostUsedBrowserInterface }) => {
    const processData = data.data.map((item) => {
        ...
        return {
            ...
            browser: item[countryKey as keyof typeof item] as string,
                            ...
                            >
                                ...
                                <div className="flex items-center gap-2 relative z-10 py-2 px-2">
                                    <span className="inline-block w-6">
                                        <img
                                            src={`/logos/${item.browser}.svg`}
                                            alt={`${item.browser} browser`}
                                            width={20}
                                            height={15}
...
export default MostUsedBrowser;
